...
def broadcast_indinst_data(isin: str, indinst_data):
    ...
    async_to_sync(channel_layer.group_send)(f"indinst_{isin}", {
        "type": "send_data", "msg_type": "indinst_data", "isin": isin, "data": indinst_data})
